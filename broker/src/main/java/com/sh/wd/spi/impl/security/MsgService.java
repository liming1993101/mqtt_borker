 ...
 */
public class MsgService implements IAuthenticator {
    ...
    public MsgService(IConfig conf) {
        this(
     ...
     */
    public MsgService(String driver, String jdbcUrl, String sqlQuery, String digestMethod) {

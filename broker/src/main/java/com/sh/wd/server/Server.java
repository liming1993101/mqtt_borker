...
import com.sh.wd.config.*;
import com.sh.wd.connections.IConnectionsManager;
import com.sh.wd.interception.HazelcastInterceptHandler;
import com.sh.wd.interception.HazelcastMsg;
import com.sh.wd.interception.InterceptHandler;
import com.sh.wd.server.config.ResourceLoaderConfig;
import com.sh.wd.server.netty.NettyAcceptor;
...
import static com.sh.wd.logging.LoggingUtils.getInterceptorIds;
...
public class Server {
    ...
    private static File defaultConfigFile() {
        URL url = Server.class.getClassLoader().getResource( IConfig.DEFAULT_CONFIG);

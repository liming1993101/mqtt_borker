...
public interface ISessionsStore {
     ...
     */
    BlockingQueue<IMessagesStore.StoredMessage> queue(String clientID);
     ...
     */
    IMessagesStore.StoredMessage secondPhaseAcknowledged(String clientID, int messageID);
    ...
    void markAsInboundInflight(String clientID, int messageID, IMessagesStore.StoredMessage msg);
